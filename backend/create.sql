...
alter table tb_game add constraint FKf3f1dhblquex0l47kxpid5c6x foreign key (genre_id) references tb_genre;
alter table tb_record add constraint FKk5bmm1a76ij93i60umu7syojv foreign key (game_id) references tb_game;
